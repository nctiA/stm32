...
{	
	...
	ssd1306_WriteCommand(0xC8); // Ekrani dikey olarak tersyüz eder.(C8 üst kisim baglanti noktalarina bakar,C0 Tam Tersi.
	
	ssd1306_WriteCommand(0xA1); // Ekrani Yatay Olarak Ters Yüz Eder(C8 ile A1 Birlikte kullanilmali, C0 ile A0 Birlikte kullanilmali)
